function PaymentForm({ tab, onSubmit, onCancel }) {
    try {
        ...
        }, [receivedAmount, tab.items, paymentMethod]);
        ...
        const handlePrint = () => {
            ...
            printContent.innerHTML = `
                ...
                <div class="divider"></div>
                <div class="total">
                    <p>Total: ${formatCurrency(calculateTabTotal(tab.items))}</p>
                    ${paymentMethod === 'cash' ? `
                ...
                <form onSubmit={handleSubmit}>
                    <div data-name="tab-summary" className="mb-3 p-3 bg-gray-900 bg-opacity-70 rounded-lg shadow-inner">
                        ...
                        <div className="flex justify-between items-center mb-1">
                            ...
                            <span className="font-medium text-xl text-green-400">{formatCurrency(calculateTabTotal(tab.items))}</span>
                        </div>
                            ...
                            <div className="mt-2 bg-gradient-to-r from-indigo-900 to-purple-800 rounded-lg p-2 shadow-lg">
                                <div className="flex items-center justify-between mb-1">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-lg font-bold text-white">{formatCurrency(calculateTabTotal(tab.items))}</span>
                                    </div>
                                </div>
                            ...
                            <div className="text-center mb-4">
                                ...
                                <div className="mt-4 p-3 bg-gray-800 bg-opacity-50 rounded-lg shadow-inner">
                                    <div className="flex justify-between items-center">
                                        <span className="text-gray-400 text-sm">Total:</span>
                                        <span className="font-bold text-green-400">{formatCurrency(calculateTabTotal(tab.items))}</span>
                                    </div>
                                    {paymentMethod === 'cash' && (
                                        <React.Fragment>
